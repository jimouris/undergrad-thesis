...
\thesissection{Doop}
    ...
    \thesissubsection{Fact Generation}
        ...
        The main motivation behind this thesis was the fact that the sequential fact generation time amounts to more than 50\% of the total execution time (either for jimple or shimple). Below are presented a few time examples of the sequential Doop Fact Generation and total execution time (both fact generation and analysis times) with Soot 2.5.0 version.
