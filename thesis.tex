...
\thesissection{Introduction}
	...
	\begin{enumerate}
		...
		\item In Chapter \ref{Ch:Soot} we present the Soot framework which is invoked by Doop to generate the facts.
		...
		\item In Chapter \ref{Ch:Conclusions} we arrive at conclusions.
	\end{enumerate}
