...
\supervisor{Antoniadis Anastasis}{M.Sc. Student NKUA}
\maketitle
...
% \supervisor{Αντωνιάδης Αναστάσης}{Μεταπτυχιακός Φοιτητής ΕΚΠΑ}
...
% \toprule
% jars:            & \textbf{Sequen.} & \textit{thrshld}                                     & \textbf{Fork/Join}                              & \textit{thrds}                                             & \textbf{Method}                                      & \textbf{Class}                                       & \textbf{3-Classes}                                   & \textbf{4-Classes}                                   \\ \midrule
% \textbf{antlr}   & 48               & \textit{\begin{tabular}[c]{@{}l@{}}2\\ 3\end{tabular}} & \begin{tabular}[c]{@{}l@{}}23\\ 25\end{tabular} & \textit{\begin{tabular}[c]{@{}l@{}}4\\ 16\\ 32\end{tabular}} & \begin{tabular}[c]{@{}l@{}}21\\ 14\\ 13\end{tabular} & \begin{tabular}[c]{@{}l@{}}20\\ 14\\ 13\end{tabular} & \begin{tabular}[c]{@{}l@{}}18\\ 12\\ 13\end{tabular} & \begin{tabular}[c]{@{}l@{}}19\\ 14\\ 13\end{tabular} \\
%                  &                  &                                                        &                                                 &                                                              &                                                      &                                                      &                                                      &                                                      \\
% \textbf{eclipse} & 27               & \textit{\begin{tabular}[c]{@{}l@{}}2\\ 3\end{tabular}} & \begin{tabular}[c]{@{}l@{}}13\\ 15\end{tabular} & \textit{\begin{tabular}[c]{@{}l@{}}4\\ 16\\ 32\end{tabular}} & \begin{tabular}[c]{@{}l@{}}13\\ 7\\ 8\end{tabular}   & \begin{tabular}[c]{@{}l@{}}11\\ 7\\ 7\end{tabular}   & \begin{tabular}[c]{@{}l@{}}10\\ 8\\ 8\end{tabular}   & \begin{tabular}[c]{@{}l@{}}11\\ 6\\ 8\end{tabular}   \\
%                  &                  &                                                        &                                                 &                                                              &                                                      &                                                      &                                                      &                                                      \\
% \textbf{jython}  & 32               & \textit{\begin{tabular}[c]{@{}l@{}}2\\ 3\end{tabular}} & \begin{tabular}[c]{@{}l@{}}16\\ 17\end{tabular} & \textit{\begin{tabular}[c]{@{}l@{}}4\\ 16\\ 32\end{tabular}} & \begin{tabular}[c]{@{}l@{}}14\\ 9\\ 9\end{tabular}   & \begin{tabular}[c]{@{}l@{}}13\\ 8\\ 8\end{tabular}   & \begin{tabular}[c]{@{}l@{}}14\\ 7\\ 8\end{tabular}   & \begin{tabular}[c]{@{}l@{}}13\\ 9\\ 8\end{tabular}   \\
%                  &                  &                                                        &                                                 &                                                              &                                                      &                                                      &                                                      &                                                      \\
% \textbf{hsqldb}  & 50               & \textit{\begin{tabular}[c]{@{}l@{}}2\\ 3\end{tabular}} & \begin{tabular}[c]{@{}l@{}}25\\ 28\end{tabular} & \textit{\begin{tabular}[c]{@{}l@{}}4\\ 16\\ 32\end{tabular}} & \begin{tabular}[c]{@{}l@{}}23\\ 15\\ 16\end{tabular} & \begin{tabular}[c]{@{}l@{}}22\\ 15\\ 18\end{tabular} & \begin{tabular}[c]{@{}l@{}}22\\ 14\\ 18\end{tabular} & \begin{tabular}[c]{@{}l@{}}20\\ 16\\ 14\end{tabular} \\
%                  &                  &                                                        &                                                 &                                                              &                                                      &                                                      &                                                      &                                                      \\
% \textbf{batik}   & 63               & \textit{\begin{tabular}[c]{@{}l@{}}2\\ 3\end{tabular}} & \begin{tabular}[c]{@{}l@{}}34\\ 37\end{tabular} & \textit{\begin{tabular}[c]{@{}l@{}}4\\ 16\\ 32\end{tabular}} & \begin{tabular}[c]{@{}l@{}}26\\ 23\\ 18\end{tabular} & \begin{tabular}[c]{@{}l@{}}26\\ 18\\ 19\end{tabular} & \begin{tabular}[c]{@{}l@{}}24\\ 20\\ 17\end{tabular} & \begin{tabular}[c]{@{}l@{}}25\\ 17\\ 17\end{tabular} \\ \bottomrule
% \end{tabular}
%     \caption{Summarizing times (seconds)}
%     \end{table}
